...
mogrify -crop 4960x3300+0+0 -resize 50% -format png *.jpg
rm *.jpg
popd

python imagesplit-bigprn-150dpi.py -d 150 -i /media/sf_E_DRIVE/pcn/$WORKDIR/resized-scans/ -o /media/sf_E_DRIVE/pcn/$WORKDIR/ -p tmp.pdf
